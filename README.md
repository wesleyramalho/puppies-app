This project is a simple react-app built to test an API made with Node.js and PostgreSQL. It also was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
